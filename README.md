...
Este repositório contém um site estático de portfólio profissional criado com HTML5, CSS3 e JavaScript puro.

## Melhorias aplicadas

- Layout moderno e responsivo com navegação clara e seções bem definidas
- Foto de perfil com moldura circular e ajuste de posição para exibir melhor o rosto
